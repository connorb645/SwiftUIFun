//
//  UnfoldedSearchBarView.swift
//  SwiftUIFun
//
//  Created by Connor Black on 13/02/2021.
//

import SwiftUI
import Combine

struct UnfoldedSearchBarView: View {
    
    @ObservedObject private var viewModel = UnfoldedSearchBarViewModel()
    ...
    var textField: some View {
        TextField("search...", text: $viewModel.searchText)
            ...
            .rotation3DEffect(.init(degrees: viewModel.searchRotation),
    ...
    var resultsView: some View {
        Rectangle()
            ...
            .rotation3DEffect(
                .init(degrees: viewModel.resultsRotation),
...
class UnfoldedSearchBarViewModel: ObservableObject {
...
struct UnfoldedSearchBarView_Previews: PreviewProvider {
    static var previews: some View {
        UnfoldedSearchBarView()
    }
}
